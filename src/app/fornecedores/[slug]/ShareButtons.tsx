...
export default function ShareButtons({ url, titulo }: { url: string; titulo: string }) {
  const [copiado, setCopiado] = useState(false);

  const texto = encodeURIComponent(`Confira ${titulo} na Vitrine ISP: ${url}`);
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <a
        ...
        className="flex items-center gap-1.5 text-xs text-green-700 bg-green-50 hover:bg-green-100 border border-green-200 px-3 py-1.5 rounded-full transition-colors"
      >
      ...
      <a
        ...
        className="flex items-center gap-1.5 text-xs text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 px-3 py-1.5 rounded-full transition-colors"
      >
        <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
