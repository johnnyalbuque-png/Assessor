    ...
    <div className="flex flex-col gap-2 shrink-0 w-full sm:w-auto">
      ...
      {instagram && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => track(fornecedorId, "site")}
          className="flex items-center justify-center gap-2 border border-pink-200 text-pink-600 hover:bg-pink-50 px-5 py-2.5 rounded-lg text-sm font-medium transition-colors"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      {linkedin && (
        <a
          ...
          rel="noopener noreferrer"
          onClick={() => track(fornecedorId, "site")}
          className="flex items-center justify-center gap-2 border border-blue-200 text-blue-700 hover:bg-blue-50 px-5 py-2.5 rounded-lg text-sm font-medium transition-colors"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
